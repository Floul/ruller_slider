...
/// A callback that formats a numeric value from a [MyCustomSlider] widget.
///
/// See also:
///
///  * [MyCustomSlider.semanticFormatterCallback], which shows an example use case.
...
class MyCustomSlider extends StatefulWidget {
  ...
  ///
  /// Ignored if this slider is created with [MyCustomSlider.adaptive].
  ///
  /// See also:
  ///
...
class _SliderRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  final ValueChanged<double> onChangeEnd;
  final SemanticFormatterCallback semanticFormatterCallback;
  final _MyCustomSliderState state;
...
class _RenderSlider extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  _RenderSlider({
    ...
    this.onChangeStart,
    this.onChangeEnd,
    @required _MyCustomSliderState state,
  ...
  final _MyCustomSliderState _state;
